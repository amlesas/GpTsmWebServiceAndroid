...
public class SEId_GenericType extends SEIdentifierType implements KvmSerializable
{
    ...
    public SEId_GenericType ()
    {
    }

    public SEId_GenericType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
