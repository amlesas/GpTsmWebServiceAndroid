...
public class DeviceApplicationLifeCycleNotificationBinding
{
    ...
    String url="http://globalplatform.org/systems-messaging/deviceapplicationlifecyclenotification";
...
//
//    public DeviceApplicationLifeCycleNotificationBinding (IServiceEvents callback)
//    {
//        this.callback = callback;
//    }
    public DeviceApplicationLifeCycleNotificationBinding(IServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public DeviceApplicationLifeCycleNotificationBinding(IServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    private void HandleActionDoneOnDeviceApplicationNotification(final HandleActionDoneOnDeviceApplicationNotificationRequestType HandleActionDoneOnDeviceApplicationNotificationRequest ) throws java.lang.Exception
    {
        execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ...
                __envelope.addMapping("http://namespaces.globalplatform.org/systems-messaging/2.1.0","HandleActionDoneOnDeviceApplicationNotificationRequest",new HandleActionDoneOnDeviceApplicationNotificationRequestType().getClass());
                __envelope.setOutputSoapObject(HandleActionDoneOnDeviceApplicationNotificationRequest);
                return __envelope;
            }
