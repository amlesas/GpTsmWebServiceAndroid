...
public class DeclareServiceInstanceReferenceRequestType extends BasicRequestType implements KvmSerializable
{
    ...
    public DeclareServiceInstanceReferenceRequestType ()
    {
    }

    public DeclareServiceInstanceReferenceRequestType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
