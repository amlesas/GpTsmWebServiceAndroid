...
public class GetServiceStateRequestType extends BasicRequestType implements KvmSerializable
{
    
    public ServiceInstanceReferenceType ServiceInstanceReference;

    public GetServiceStateRequestType ()
    {
    }

    public GetServiceStateRequestType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
