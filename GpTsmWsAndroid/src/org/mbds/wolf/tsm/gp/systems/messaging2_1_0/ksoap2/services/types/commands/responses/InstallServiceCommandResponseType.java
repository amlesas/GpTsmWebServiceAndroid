...
public class InstallServiceCommandResponseType extends ServiceCommandResponseType implements KvmSerializable
{

    public InstallServiceCommandResponseType ()
    {
    }

    public InstallServiceCommandResponseType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
