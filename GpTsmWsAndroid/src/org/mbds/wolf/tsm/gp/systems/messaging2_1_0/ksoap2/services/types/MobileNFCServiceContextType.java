...
public class MobileNFCServiceContextType extends AttributeContainer implements KvmSerializable
{
    ...
    public MobileNFCServiceContextType ()
    {
    }

    public MobileNFCServiceContextType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
