...
public class GetSEMobileSubscriptionIdentifierRequestType extends BasicRequestType implements KvmSerializable
{
    ...
    public GetSEMobileSubscriptionIdentifierRequestType ()
    {
    }

    public GetSEMobileSubscriptionIdentifierRequestType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
