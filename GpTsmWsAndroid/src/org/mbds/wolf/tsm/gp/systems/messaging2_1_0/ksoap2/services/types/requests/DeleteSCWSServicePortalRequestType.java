...
public class DeleteSCWSServicePortalRequestType extends BasicRequestType implements KvmSerializable
{
    ...
    public String ServicePortalIdentifier;

    public DeleteSCWSServicePortalRequestType ()
    {
    }

    public DeleteSCWSServicePortalRequestType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
        ...
        if (soapObject.hasProperty("ServicePortalIdentifier"))
        {	
	        java.lang.Object obj = soapObject.getProperty("ServicePortalIdentifier");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class))
            {
                SoapPrimitive j =(SoapPrimitive) obj;
                if(j.toString()!=null)
                {
                    this.ServicePortalIdentifier = j.toString();
                }
	        }
	        else if (obj!= null && obj instanceof String){
                this.ServicePortalIdentifier = (String)obj;
            }    
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        {
            return ServicePortalIdentifier!=null?ServicePortalIdentifier:SoapPrimitive.NullSkip;
        }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==count+4)
        {
            ...
            info.name = "ServicePortalIdentifier";
            info.namespace= "http://namespaces.globalplatform.org/systems-messaging/2.1.0";
        }
