...
public class CCMCommandType extends Vector< String> implements KvmSerializable
{
    
    public CCMCommandType(){}
    
    public CCMCommandType(AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
        if (inObj == null)
            return;
