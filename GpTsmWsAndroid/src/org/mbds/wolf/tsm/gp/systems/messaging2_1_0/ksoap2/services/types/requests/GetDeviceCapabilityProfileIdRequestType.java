...
public class GetDeviceCapabilityProfileIdRequestType extends BasicRequestType implements KvmSerializable
{
    
    public MobileSubscriptionIdentifierType MobileSubscription;

    public GetDeviceCapabilityProfileIdRequestType ()
    {
    }

    public GetDeviceCapabilityProfileIdRequestType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
