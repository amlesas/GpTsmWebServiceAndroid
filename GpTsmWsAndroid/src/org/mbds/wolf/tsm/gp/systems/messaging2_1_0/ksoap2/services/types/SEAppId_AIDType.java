...
public class SEAppId_AIDType extends SEApplicationIdentifierType implements KvmSerializable
{
    
    public String AID;

    public SEAppId_AIDType ()
    {
    }

    public SEAppId_AIDType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
        ...
        {	
	        java.lang.Object obj = soapObject.getProperty("AID");
