...
public class GlobalServiceManagementCallBackBinding
{
...
//    public GlobalServiceManagementCallBackBinding(){}
//
//    public GlobalServiceManagementCallBackBinding (IServiceEvents callback)
//    {
//        this.callback = callback;
//    }
    public GlobalServiceManagementCallBackBinding(IServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public GlobalServiceManagementCallBackBinding(IServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    public void DeployService(final DeployServiceResponseType DeployServiceResponse ) throws java.lang.Exception
    {
        execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ...
                __envelope.addMapping("http://namespaces.globalplatform.org/systems-messaging/2.1.0","DeployServiceResponse",new DeployServiceResponseType().getClass());
                __envelope.setOutputSoapObject(DeployServiceResponse);
                return __envelope;
            }
    ...
    public void UpgradeService(final UpgradeServiceResponseType UpgradeServiceResponse ) throws java.lang.Exception
    {
        execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
                __envelope.addMapping("http://namespaces.globalplatform.org/systems-messaging/2.1.0","UpgradeServiceResponse",new UpgradeServiceResponseType().getClass());
                __envelope.setOutputSoapObject(UpgradeServiceResponse);
                return __envelope;
            }
    ...
    public void ExchangeServiceData(final ExchangeServiceDataResponseType ExchangeServiceDataResponse ) throws java.lang.Exception
    {
        execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
                __envelope.addMapping("http://namespaces.globalplatform.org/systems-messaging/2.1.0","ExchangeServiceDataResponse",new ExchangeServiceDataResponseType().getClass());
                __envelope.setOutputSoapObject(ExchangeServiceDataResponse);
                return __envelope;
            }
