...
public class CCCMScenario2A_CreateFirstSSDKeysetCommandResponseType extends CreateFirstSSDKeysetCommandResponseType implements KvmSerializable
{

    public CCCMScenario2A_CreateFirstSSDKeysetCommandResponseType ()
    {
    }

    public CCCMScenario2A_CreateFirstSSDKeysetCommandResponseType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
