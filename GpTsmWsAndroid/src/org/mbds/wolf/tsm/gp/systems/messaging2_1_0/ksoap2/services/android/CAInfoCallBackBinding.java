...
public class CAInfoCallBackBinding
{
...
//
//    public CAInfoCallBackBinding (IServiceEvents callback)
//    {
//        this.callback = callback;
//    }
    public CAInfoCallBackBinding(IServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public CAInfoCallBackBinding(IServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    public void AuditCAInformation(final GetCAInformationResponseType AuditCAInformationResponse ) throws java.lang.Exception
    {
        execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ...
                __envelope.addMapping("http://namespaces.globalplatform.org/systems-messaging/2.1.0","AuditCAInformationResponse",new GetCAInformationResponseType().getClass());
                __envelope.setOutputSoapObject(AuditCAInformationResponse);
                return __envelope;
            }
