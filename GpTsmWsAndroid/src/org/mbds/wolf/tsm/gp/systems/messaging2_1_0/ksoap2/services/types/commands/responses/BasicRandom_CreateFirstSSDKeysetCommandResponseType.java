...
public class BasicRandom_CreateFirstSSDKeysetCommandResponseType extends CreateFirstSSDKeysetCommandResponseType implements KvmSerializable
{
    
    public KeySetType keySet;

    public BasicRandom_CreateFirstSSDKeysetCommandResponseType ()
    {
    }

    public BasicRandom_CreateFirstSSDKeysetCommandResponseType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
