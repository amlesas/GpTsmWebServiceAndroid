...
public class EndConversationRequestType extends BasicRequestType implements KvmSerializable
{
    
    public BigInteger ConversationID=BigInteger.ZERO;

    public EndConversationRequestType ()
    {
    }

    public EndConversationRequestType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
