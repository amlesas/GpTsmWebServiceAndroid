...
public class GetServiceInstanceReferenceDescriptorRequestType extends BasicRequestType implements KvmSerializable
{
    
    public ServiceInstanceReferenceType ServiceInstanceReference;

    public GetServiceInstanceReferenceDescriptorRequestType ()
    {
    }

    public GetServiceInstanceReferenceDescriptorRequestType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
