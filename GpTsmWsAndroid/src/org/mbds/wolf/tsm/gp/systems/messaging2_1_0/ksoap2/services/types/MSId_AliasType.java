...
public class MSId_AliasType extends MobileSubscriptionIdentifierType implements KvmSerializable
{
    
    public String Alias;

    public MSId_AliasType ()
    {
    }

    public MSId_AliasType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
        ...
        {	
	        java.lang.Object obj = soapObject.getProperty("Alias");
