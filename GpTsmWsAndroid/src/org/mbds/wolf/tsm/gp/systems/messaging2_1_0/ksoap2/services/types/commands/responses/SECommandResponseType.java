...
public class SECommandResponseType extends AttributeContainer implements KvmSerializable
{

    public SECommandResponseType ()
    {
    }

    public SECommandResponseType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
