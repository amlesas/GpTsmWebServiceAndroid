...
public class CCCMCertificatesManagementBinding
{
    ...
    String url="http://globalplatform.org/systems-messaging/ccmcertificatesmanagement";
...
//
//    public CCCMCertificatesManagementBinding (IServiceEvents callback)
//    {
//        this.callback = callback;
//    }
    public CCCMCertificatesManagementBinding(IServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public CCCMCertificatesManagementBinding(IServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    private EnrollSSDOwnerCertificateResponseType EnrollSSDOwnerCertificate(final EnrollSSDOwnerCertificateRequestType EnrollSSDOwnerCertificateRequest ) throws java.lang.Exception
    {
        return (EnrollSSDOwnerCertificateResponseType)execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ...
                __envelope.addMapping("http://namespaces.globalplatform.org/systems-messaging/2.1.0","EnrollSSDOwnerCertificateRequest",new EnrollSSDOwnerCertificateRequestType().getClass());
                __envelope.setOutputSoapObject(EnrollSSDOwnerCertificateRequest);
                return __envelope;
            }
