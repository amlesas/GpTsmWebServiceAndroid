...
public class MobileNFCServiceResultContextType extends AttributeContainer implements KvmSerializable
{
    
    public BigInteger UsedBearer;

    public MobileNFCServiceResultContextType ()
    {
    }

    public MobileNFCServiceResultContextType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
