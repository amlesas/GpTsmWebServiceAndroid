...
public class DelegatedManagementBinding
{
    ...
    String url="http://globalplatform.org/systems-messaging/delegatedmanagement";
...
//
//    public DelegatedManagementBinding (IServiceEvents callback)
//    {
//        this.callback = callback;
//    }
    public DelegatedManagementBinding(IServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public DelegatedManagementBinding(IServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    private GenerateDMTokenResponseType GenerateDMToken(final GenerateDMTokenRequestType GenerateDMTokenRequest ) throws java.lang.Exception
    {
        return (GenerateDMTokenResponseType)execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ...
                __envelope.addMapping("http://namespaces.globalplatform.org/systems-messaging/2.1.0","GenerateDMTokenRequest",new GenerateDMTokenRequestType().getClass());
                __envelope.setOutputSoapObject(GenerateDMTokenRequest);
                return __envelope;
            }
...
//This feature is available in Premium account, Check http://EasyWsdl.com/Payment/PremiumAccountDetails to see all benefits of Premium account
    ...
    public android.os.AsyncTask VerifyDMReceiptAsync(final String VerifyDMReceiptRequest)
    {
        return executeAsync(new Functions.IFunc< String>() {
            public String Func() throws java.lang.Exception {
                return VerifyDMReceipt( VerifyDMReceiptRequest);
            }
        },"VerifyDMReceipt");
    }
