...
public class SCWSManagementBinding
{
...
//    public SCWSManagementBinding(){}
//
//    public SCWSManagementBinding (IServiceEvents callback)
//    {
//        this.callback = callback;
//    }
    public SCWSManagementBinding(IServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public SCWSManagementBinding(IServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    public void LoadSCWSServicePortal(final LoadSCWSServicePortalRequestType LoadSCWSServicePortalRequest ) throws java.lang.Exception
    {
        execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ...
                __envelope.addMapping("http://namespaces.globalplatform.org/systems-messaging/2.1.0","LoadSCWSServicePortalRequest",new LoadSCWSServicePortalRequestType().getClass());
                __envelope.setOutputSoapObject(LoadSCWSServicePortalRequest);
                return __envelope;
            }
