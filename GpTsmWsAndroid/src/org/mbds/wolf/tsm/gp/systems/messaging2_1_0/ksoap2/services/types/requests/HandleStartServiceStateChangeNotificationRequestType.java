...
public class HandleStartServiceStateChangeNotificationRequestType extends BasicRequestType implements KvmSerializable
{
    ...
    public HandleStartServiceStateChangeNotificationRequestType ()
    {
    }

    public HandleStartServiceStateChangeNotificationRequestType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
