...
public class PersoDeviceIns extends Vector< Data> implements KvmSerializable
{
    
    public PersoDeviceIns(){}
    
    public PersoDeviceIns(AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
        if (inObj == null)
            return;
