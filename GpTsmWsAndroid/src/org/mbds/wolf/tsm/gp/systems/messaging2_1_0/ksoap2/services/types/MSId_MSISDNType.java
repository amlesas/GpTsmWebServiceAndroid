...
public class MSId_MSISDNType extends MobileSubscriptionIdentifierType implements KvmSerializable
{
    
    public String MSISDN;

    public MSId_MSISDNType ()
    {
    }

    public MSId_MSISDNType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
        ...
        {	
	        java.lang.Object obj = soapObject.getProperty("MSISDN");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class))
            {
                SoapPrimitive j =(SoapPrimitive) obj;
                if(j.toString()!=null)
                {
                    this.MSISDN = j.toString();
                }
	        }
