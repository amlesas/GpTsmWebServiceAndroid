...
public class SuspendOrResumeServiceResponseDataType extends AttributeContainer implements KvmSerializable
{

    public SuspendOrResumeServiceResponseDataType ()
    {
    }

    public SuspendOrResumeServiceResponseDataType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
