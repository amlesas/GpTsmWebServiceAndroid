...
public class ICCData extends Vector< DataSet> implements KvmSerializable
{
    
    public ICCData(){}
    
    public ICCData(AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
        if (inObj == null)
            return;
