...
public class SECommandType extends AttributeContainer implements KvmSerializable
{

    public SECommandType ()
    {
    }

    public SECommandType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
