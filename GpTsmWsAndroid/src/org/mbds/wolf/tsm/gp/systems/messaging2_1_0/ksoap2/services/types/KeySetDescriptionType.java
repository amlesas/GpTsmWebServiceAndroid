...
public class KeySetDescriptionType extends AttributeContainer implements KvmSerializable
{

    public KeySetDescriptionType ()
    {
    }

    public KeySetDescriptionType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
