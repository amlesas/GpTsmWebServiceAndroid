...
public class ModuleData extends Vector< DataSet> implements KvmSerializable
{
    
    public ModuleData(){}
    
    public ModuleData(AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
        if (inObj == null)
            return;
