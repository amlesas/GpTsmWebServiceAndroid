...
public class LoadSCWSServicePortalRequestType extends BasicRequestType implements KvmSerializable
{
    ...
    public LoadSCWSServicePortalRequestType ()
    {
    }

    public LoadSCWSServicePortalRequestType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
