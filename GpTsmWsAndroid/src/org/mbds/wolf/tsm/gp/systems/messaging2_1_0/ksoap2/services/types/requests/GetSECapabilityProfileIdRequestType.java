...
public class GetSECapabilityProfileIdRequestType extends BasicRequestType implements KvmSerializable
{
    
    public SEIdentifierType SecureElement;

    public GetSECapabilityProfileIdRequestType ()
    {
    }

    public GetSECapabilityProfileIdRequestType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
