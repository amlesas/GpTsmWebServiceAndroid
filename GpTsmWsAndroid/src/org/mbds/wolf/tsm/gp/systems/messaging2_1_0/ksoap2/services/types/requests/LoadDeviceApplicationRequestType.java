...
import org.mbds.wolf.tsm.gp.systems.messaging2_1_0.ksoap2.services.types.DeviceInstallationModeType;
...
public class LoadDeviceApplicationRequestType extends BasicRequestType implements KvmSerializable
{
    ...
    public DeviceInstallationModeType PreferredInstallationMode;

    public LoadDeviceApplicationRequestType ()
    {
    }

    public LoadDeviceApplicationRequestType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
        ...
        if (soapObject.hasProperty("PreferredInstallationMode"))
        {	
	        java.lang.Object j = soapObject.getProperty("PreferredInstallationMode");
	        this.PreferredInstallationMode = (DeviceInstallationModeType)envelope.get(j,DeviceInstallationModeType.class);
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        {
            return PreferredInstallationMode!=null?PreferredInstallationMode:SoapPrimitive.NullSkip;
        }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==count+4)
        {
            info.type = DeviceInstallationModeType.class;
            info.name = "PreferredInstallationMode";
            info.namespace= "http://namespaces.globalplatform.org/systems-messaging/2.1.0";
        }
