...
public class MobileSubscriptionLifeCycleNotificationBinding
{
    ...
    String url="http://globalplatform.org/systems-messaging/mobilesubscriptionlifecyclenotification";
...
//    public MobileSubscriptionLifeCycleNotificationBinding(){}
//
//    public MobileSubscriptionLifeCycleNotificationBinding (IServiceEvents callback)
//    {
//        this.callback = callback;
//    }
    public MobileSubscriptionLifeCycleNotificationBinding(IServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public MobileSubscriptionLifeCycleNotificationBinding(IServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    public void HandleMobileSubscriptionIdentifierChangedNotification(final HandleMobileSubscriptionIdentifierChangedNotificationRequestType HandleMobileSubscriptionIdentifierChangedNotificationRequest ) throws java.lang.Exception
    {
        execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ...
                __envelope.addMapping("http://namespaces.globalplatform.org/systems-messaging/2.1.0","HandleMobileSubscriptionIdentifierChangedNotificationRequest",new HandleMobileSubscriptionIdentifierChangedNotificationRequestType().getClass());
                __envelope.setOutputSoapObject(HandleMobileSubscriptionIdentifierChangedNotificationRequest);
                return __envelope;
            }
