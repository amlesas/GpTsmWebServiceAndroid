...
import org.mbds.wolf.tsm.gp.systems.messaging2_1_0.ksoap2.services.types.DeviceDeletionModeType;
...
public class DeleteDeviceApplicationRequestType extends BasicRequestType implements KvmSerializable
{
    ...
    public DeviceDeletionModeType PreferredDeletionMode;

    public DeleteDeviceApplicationRequestType ()
    {
    }

    public DeleteDeviceApplicationRequestType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
        ...
        if (soapObject.hasProperty("PreferredDeletionMode"))
        {	
	        java.lang.Object j = soapObject.getProperty("PreferredDeletionMode");
	        this.PreferredDeletionMode = (DeviceDeletionModeType)envelope.get(j,DeviceDeletionModeType.class);
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        {
            return PreferredDeletionMode!=null?PreferredDeletionMode:SoapPrimitive.NullSkip;
        }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==count+4)
        {
            info.type = DeviceDeletionModeType.class;
            info.name = "PreferredDeletionMode";
            info.namespace= "http://namespaces.globalplatform.org/systems-messaging/2.1.0";
        }
