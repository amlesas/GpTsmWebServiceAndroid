...
public class SEId_ExtendableType extends SEIdentifierType implements KvmSerializable
{

    public SEId_ExtendableType ()
    {
    }

    public SEId_ExtendableType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
