...
public class ScriptSendingBinding
{
...
//    public ScriptSendingBinding(){}
//
//    public ScriptSendingBinding (IServiceEvents callback)
//    {
//        this.callback = callback;
//    }
    public ScriptSendingBinding(IServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public ScriptSendingBinding(IServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    public void BeginConversation(final BeginConversationRequestType BeginConversationRequest ) throws java.lang.Exception
    {
        execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ...
                __envelope.addMapping("http://namespaces.globalplatform.org/systems-messaging/2.1.0","BeginConversationRequest",new BeginConversationRequestType().getClass());
                __envelope.setOutputSoapObject(BeginConversationRequest);
                return __envelope;
            }
    ...
    public void SendScript(final SendScriptRequestType SendScriptRequest ) throws java.lang.Exception
    {
        execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
                __envelope.addMapping("http://namespaces.globalplatform.org/systems-messaging/2.1.0","SendScriptRequest",new SendScriptRequestType().getClass());
                __envelope.setOutputSoapObject(SendScriptRequest);
                return __envelope;
            }
