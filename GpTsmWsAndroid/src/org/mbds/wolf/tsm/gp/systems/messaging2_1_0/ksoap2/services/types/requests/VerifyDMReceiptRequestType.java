...
public class VerifyDMReceiptRequestType extends BasicRequestType implements KvmSerializable
{
    ...
    public ArrayList< CCMCommandStatusType>CCMCommandStatus =new ArrayList<CCMCommandStatusType>();

    public VerifyDMReceiptRequestType ()
    {
    }

    public VerifyDMReceiptRequestType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
        ...
        if (soapObject.hasProperty("CCMCommandStatus"))
        {	
	        int size = soapObject.getPropertyCount();
	        this.CCMCommandStatus = new ArrayList<CCMCommandStatusType>();
	        for (int i0=0;i0< size;i0++)
	        {
	            PropertyInfo info=new PropertyInfo();
	            soapObject.getPropertyInfo(i0, info);
                java.lang.Object obj = info.getValue();
	            if (obj!=null && info.name.equals("CCMCommandStatus"))
	            {
                    java.lang.Object j =info.getValue();
	                CCMCommandStatusType j1= (CCMCommandStatusType)envelope.get(j,CCMCommandStatusType.class);
	                this.CCMCommandStatus.add(j1);
	            }
	        }
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex>=count+3 && propertyIndex< count+ 3+this.CCMCommandStatus.size())
        {
            return CCMCommandStatus.get(propertyIndex-(count+3));
        }
    ...
    public int getPropertyCount() {
        return super.getPropertyCount()+3+CCMCommandStatus.size();
    }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex>=count+3 && propertyIndex <= count+3+this.CCMCommandStatus.size())
        {
            info.type = CCMCommandStatusType.class;
            info.name = "CCMCommandStatus";
            info.namespace= "http://namespaces.globalplatform.org/systems-messaging/2.1.0";
        }
