...
public class ShippingInformation extends Vector< Data> implements KvmSerializable
{
    
    public ShippingInformation(){}
    
    public ShippingInformation(AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
        if (inObj == null)
            return;
