...
public class HandleSEDeviceChangedNotificationRequestType extends BasicRequestType implements KvmSerializable
{
    ...
    public BigInteger OldDeviceCapabilityProfileId=BigInteger.ZERO;
    
    public BigInteger NewDeviceCapabilityProfileId=BigInteger.ZERO;

    public HandleSEDeviceChangedNotificationRequestType ()
    {
    }

    public HandleSEDeviceChangedNotificationRequestType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
        ...
        if (soapObject.hasProperty("OldDeviceCapabilityProfileId"))
        {	
	        java.lang.Object obj = soapObject.getProperty("OldDeviceCapabilityProfileId");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class))
            {
                SoapPrimitive j =(SoapPrimitive) obj;
                if(j.toString()!=null)
                {
                    this.OldDeviceCapabilityProfileId = new BigInteger(j.toString());
                }
	        }
	        else if (obj!= null && obj instanceof BigInteger){
                this.OldDeviceCapabilityProfileId = (BigInteger)obj;
            }    
        }
        if (soapObject.hasProperty("NewDeviceCapabilityProfileId"))
        {	
	        java.lang.Object obj = soapObject.getProperty("NewDeviceCapabilityProfileId");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class))
            {
                SoapPrimitive j =(SoapPrimitive) obj;
                if(j.toString()!=null)
                {
                    this.NewDeviceCapabilityProfileId = new BigInteger(j.toString());
                }
	        }
	        else if (obj!= null && obj instanceof BigInteger){
                this.NewDeviceCapabilityProfileId = (BigInteger)obj;
            }    
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        {
            return OldDeviceCapabilityProfileId!=null?OldDeviceCapabilityProfileId.toString():SoapPrimitive.NullSkip;
        }
        if(propertyIndex==count+3)
        {
            return NewDeviceCapabilityProfileId!=null?NewDeviceCapabilityProfileId.toString():SoapPrimitive.NullSkip;
        }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==count+2)
        {
            ...
            info.name = "OldDeviceCapabilityProfileId";
            info.namespace= "http://namespaces.globalplatform.org/systems-messaging/2.1.0";
        }
        if(propertyIndex==count+3)
        {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "NewDeviceCapabilityProfileId";
            info.namespace= "http://namespaces.globalplatform.org/systems-messaging/2.1.0";
        }
