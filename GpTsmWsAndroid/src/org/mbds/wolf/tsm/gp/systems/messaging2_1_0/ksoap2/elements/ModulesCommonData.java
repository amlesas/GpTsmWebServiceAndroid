...
public class ModulesCommonData extends Vector< DataSet> implements KvmSerializable
{
    
    public ModulesCommonData(){}
    
    public ModulesCommonData(AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
        if (inObj == null)
            return;
