...
public class GlobalEligibilityInfoBinding
{
    interface CHIIWcfMethod
    {
    ...
    String url="http://globalplatform.org/systems-messaging/globaleligibilityinfo";
...
//
//    public GlobalEligibilityInfoBinding (IServiceEvents callback)
//    {
//        this.callback = callback;
//    }
    public GlobalEligibilityInfoBinding(IServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public GlobalEligibilityInfoBinding(IServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    private CheckGlobalEligibilityResponseType CheckGlobalEligibility(final CheckGlobalEligibilityRequestType CheckGlobalEligibilityRequest ) throws java.lang.Exception
    {
        return (CheckGlobalEligibilityResponseType)execute(new CHIIWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ...
                __envelope.addMapping("http://namespaces.globalplatform.org/systems-messaging/2.1.0","CheckGlobalEligibilityRequest",new CheckGlobalEligibilityRequestType().getClass());
                __envelope.setOutputSoapObject(CheckGlobalEligibilityRequest);
                return __envelope;
            }
