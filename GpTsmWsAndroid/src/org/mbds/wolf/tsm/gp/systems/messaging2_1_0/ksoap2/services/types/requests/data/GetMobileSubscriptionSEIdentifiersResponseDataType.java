...
public class GetMobileSubscriptionSEIdentifiersResponseDataType extends Vector< SEIdentifierType> implements KvmSerializable
{
    
    public GetMobileSubscriptionSEIdentifiersResponseDataType(){}
    
    public GetMobileSubscriptionSEIdentifiersResponseDataType(AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
        if (inObj == null)
            return;
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (obj!=null && obj instanceof AttributeContainer)
                {
                    ...
                    SEIdentifierType j1= (SEIdentifierType)envelope.get(j,SEIdentifierType.class);
                    add(j1);
                }
            }
