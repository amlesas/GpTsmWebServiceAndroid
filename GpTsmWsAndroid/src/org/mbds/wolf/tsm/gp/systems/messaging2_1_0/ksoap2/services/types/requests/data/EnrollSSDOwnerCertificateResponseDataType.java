...
public class EnrollSSDOwnerCertificateResponseDataType extends AttributeContainer implements KvmSerializable
{
    
    public String SSDOwnerCertificate;

    public EnrollSSDOwnerCertificateResponseDataType ()
    {
    }

    public EnrollSSDOwnerCertificateResponseDataType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
