...
public class InstallServiceCommandType extends ServiceCommandType implements KvmSerializable
{

    public InstallServiceCommandType ()
    {
    }

    public InstallServiceCommandType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
