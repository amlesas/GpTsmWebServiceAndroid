...
public class CAInfoBinding
{
    ...
    String url="http://globalplatform.org/systems-messaging/cainfo";
...
//
//    public CAInfoBinding (IServiceEvents callback)
//    {
//        this.callback = callback;
//    }
    public CAInfoBinding(IServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public CAInfoBinding(IServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    public GetCAInformationResponseType GetCAInformation(final GetCAInformationRequestType GetCAInformationRequest ) throws java.lang.Exception
    {
        return (GetCAInformationResponseType)execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ...
                __envelope.addMapping("http://namespaces.globalplatform.org/systems-messaging/2.1.0","GetCAInformationRequest",new GetCAInformationRequestType().getClass());
                __envelope.setOutputSoapObject(GetCAInformationRequest);
                return __envelope;
            }
    ...
    public android.os.AsyncTask AuditCAInformationAsync(final String AuditCAInformationRequest)
    {
        return executeAsync(new Functions.IFunc< Void>()
        {
            ...
            public Void Func() throws java.lang.Exception {
                AuditCAInformation( AuditCAInformationRequest);
                return null;
            }
        },"AuditCAInformation");
    }
