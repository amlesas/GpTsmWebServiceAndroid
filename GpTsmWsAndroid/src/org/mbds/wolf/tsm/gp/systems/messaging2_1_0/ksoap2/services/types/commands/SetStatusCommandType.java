...
public class SetStatusCommandType extends SECommandType implements KvmSerializable
{
    ...
    public SetStatusCommandType ()
    {
    }

    public SetStatusCommandType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
        ...
        if (soapObject.hasProperty("LockControl"))
        {	
	        java.lang.Object obj = soapObject.getProperty("LockControl");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class))
            {
                SoapPrimitive j =(SoapPrimitive) obj;
                if(j.toString()!=null)
                {
                    this.LockControl = new Boolean(j.toString());
                }
	        }
	        else if (obj!= null && obj instanceof Boolean){
                this.LockControl = (Boolean)obj;
            }    
        }
