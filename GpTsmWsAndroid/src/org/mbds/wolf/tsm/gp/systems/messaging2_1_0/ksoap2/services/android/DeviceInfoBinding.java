...
public class DeviceInfoBinding
{
    ...
    String url="http://globalplatform.org/systems-messaging/deviceinfo";
...
//
//    public DeviceInfoBinding (IServiceEvents callback)
//    {
//        this.callback = callback;
//    }
    public DeviceInfoBinding(IServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public DeviceInfoBinding(IServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    private GetDeviceCapabilityProfileIdResponseType GetDeviceCapabilityProfileId(final GetDeviceCapabilityProfileIdRequestType GetDeviceCapabilityProfileIdRequest ) throws java.lang.Exception
    {
        return (GetDeviceCapabilityProfileIdResponseType)execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ...
                __envelope.addMapping("http://namespaces.globalplatform.org/systems-messaging/2.1.0","GetDeviceCapabilityProfileIdRequest",new GetDeviceCapabilityProfileIdRequestType().getClass());
                __envelope.setOutputSoapObject(GetDeviceCapabilityProfileIdRequest);
                return __envelope;
            }
