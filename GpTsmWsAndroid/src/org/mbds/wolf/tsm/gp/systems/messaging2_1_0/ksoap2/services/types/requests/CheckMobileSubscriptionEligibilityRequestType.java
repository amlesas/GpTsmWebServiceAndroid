...
public class CheckMobileSubscriptionEligibilityRequestType extends BasicRequestType implements KvmSerializable
{
    ...
    public CheckMobileSubscriptionEligibilityRequestType ()
    {
    }

    public CheckMobileSubscriptionEligibilityRequestType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
