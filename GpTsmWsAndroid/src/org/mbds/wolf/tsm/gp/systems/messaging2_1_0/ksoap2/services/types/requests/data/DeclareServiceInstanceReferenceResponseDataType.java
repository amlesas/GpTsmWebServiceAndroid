...
public class DeclareServiceInstanceReferenceResponseDataType extends AttributeContainer implements KvmSerializable
{
    
    public BigInteger ServiceInstanceState=BigInteger.ZERO;

    public DeclareServiceInstanceReferenceResponseDataType ()
    {
    }

    public DeclareServiceInstanceReferenceResponseDataType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
