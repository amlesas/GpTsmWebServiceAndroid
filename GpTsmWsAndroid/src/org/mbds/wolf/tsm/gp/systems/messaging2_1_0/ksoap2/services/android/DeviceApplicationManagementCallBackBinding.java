...
public class DeviceApplicationManagementCallBackBinding
{
...
//    public DeviceApplicationManagementCallBackBinding(){}
//
//    public DeviceApplicationManagementCallBackBinding (IServiceEvents callback)
//    {
//        this.callback = callback;
//    }
    public DeviceApplicationManagementCallBackBinding(IServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public DeviceApplicationManagementCallBackBinding(IServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    private void LoadDeviceApplication(final LoadDeviceApplicationResponseType LoadDeviceApplicationResponse ) throws java.lang.Exception
    {
        execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ...
                __envelope.addMapping("http://namespaces.globalplatform.org/systems-messaging/2.1.0","LoadDeviceApplicationResponse",new LoadDeviceApplicationResponseType().getClass());
                __envelope.setOutputSoapObject(LoadDeviceApplicationResponse);
                return __envelope;
            }
    ...
    public android.os.AsyncTask LoadDeviceApplicationAsync(final LoadDeviceApplicationResponseType LoadDeviceApplicationResponse)
    {
        return executeAsync(
...
//                LoadDeviceApplication( LoadDeviceApplicationResponse);
//                return null;
//            }
//        }
        		,"LoadDeviceApplication");
...
//This feature is available in Premium account, Check http://EasyWsdl.com/Payment/PremiumAccountDetails to see all benefits of Premium account
    ...
    public android.os.AsyncTask DeleteDeviceApplicationAsync(final String DeleteDeviceApplicationResponse)
    {
        return executeAsync(new Functions.IFunc< Void>()
        {
            @Override
            public Void Func() throws java.lang.Exception {
                DeleteDeviceApplication( DeleteDeviceApplicationResponse);
                return null;
            }
...
*/    protected java.lang.Object execute(IWcfMethod wcfMethod,String methodName) throws java.lang.Exception
    ...
    protected < T> android.os.AsyncTask  executeAsync(final LoadDeviceApplicationResponseType LoadDeviceApplicationResponse,final java.lang.String methodName)
    {
