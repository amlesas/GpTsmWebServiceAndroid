...
public class SEAuditCallBackBinding
{
...
//    public SEAuditCallBackBinding(){}
//
//    public SEAuditCallBackBinding (IServiceEvents callback)
//    {
//        this.callback = callback;
//    }
    public SEAuditCallBackBinding(IServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public SEAuditCallBackBinding(IServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    public void GetApplicationOrELFStatus(final GetApplicationOrELFStatusResponseType GetApplicationOrELFStatusResponse ) throws java.lang.Exception
    {
        execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ...
                __envelope.addMapping("http://namespaces.globalplatform.org/systems-messaging/2.1.0","GetApplicationOrELFStatusResponse",new GetApplicationOrELFStatusResponseType().getClass());
                __envelope.setOutputSoapObject(GetApplicationOrELFStatusResponse);
                return __envelope;
            }
