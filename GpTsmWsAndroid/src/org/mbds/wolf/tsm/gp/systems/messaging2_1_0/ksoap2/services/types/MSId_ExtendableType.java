...
public class MSId_ExtendableType extends MobileSubscriptionIdentifierType implements KvmSerializable
{

    public MSId_ExtendableType ()
    {
    }

    public MSId_ExtendableType (AttributeContainer inObj,ExtendedSoapSerializationEnvelope envelope)
    {
